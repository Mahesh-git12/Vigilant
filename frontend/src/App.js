...
// import VoiceSOSConsentModal from './components/VoiceSOSConsentModal';
// import VoiceSOSFab from './components/VoiceSOSFab';
// import { AppBar, Toolbar, Button, Box, Avatar, Snackbar, Alert } from '@mui/material';
// import SecurityIcon from '@mui/icons-material/Security';
// import SafetyResources from './pages/SafetyResources';
// import axios from "axios";
...
//         }}
//       >
//         <Toolbar disableGutters sx={{ minHeight: 72, width: '100vw', px: { xs: 1, sm: 3 } }}>
//           <Avatar
//             sx={{
//               bgcolor: 'primary.main',
//               mr: 2,
...
//       <Box
//         sx={{
//           width: '100vw',               // Fill full viewport
//           minHeight: '100vh',
//           margin: 0,
//           overflowX: 'hidden',
//           display: 'flex',
...
//         {!voiceConsent && isLoggedIn && (
//           <VoiceSOSConsentModal open={!voiceConsent} onAllow={handleAllowVoiceSOS} onDeny={handleDenyVoiceSOS} />
//         )}
